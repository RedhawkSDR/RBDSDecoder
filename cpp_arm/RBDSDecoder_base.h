...
class RBDSDecoder_base : public Resource_impl
{
    friend class ExtendedEvent_MessageEvent_Out_i;
    ...
    protected:
        ProcessThread<RBDSDecoder_base> *serviceThread; 
        ...
        ExtendedEvent_MessageEvent_Out_i *Message_Out;
